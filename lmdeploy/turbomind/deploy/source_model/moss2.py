...
class Moss2Reader(BaseReader):
    ...
    def ffn_norm(self, i: int):
        ...
        return self.params[
            f'{self.attn_layer_prefix}.{i}.ffn_norm.weight']


@INPUT_MODELS.register_module(name='moss2')
class Moss2Model(BaseInputModel):
    """Moss2 model in hf format."""
